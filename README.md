...
The repo is the official implementation for [Network-wide Freeway Traffic Estimation Using Sparse Sensor Data: A Dirichlet Graph Auto-Encoder Approach](https://ieeexplore.ieee.org/document/11202667) published in _IEEE Transactions on Intelligent Transportation Systems_.
...
![alt text](images/DGAE-1.png) Fig.1. Illustration of the foundational framework of the Dirichlet graph auto-encoder.
