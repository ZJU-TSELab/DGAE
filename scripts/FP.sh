...
python main.py  --model $model \
                ...
                --data_path $data_path --unknown_nodes_path '/home/zqs/traffic_project/InductiveGNN/data/METR-LA/unknown_nodes.npy' \
...
#     python main.py  --model $model \
#                     --loss mse --patience $patience --num_workers 8  --scheduler None --stop_based 'train_total' --seed $seed \
#                     --max_epoch $mepoch --lr $lr --batch_size $bs \
#                     --diff_alpha $diff_alpha --latent_dim $latent_dim --k_hop $k_hop\
#                     --t_mark --miss_mark \
#                     --input_features $infea --target_features $tarfea \
#                     --input_len 12 --pred_len 0 --look_back 12 --slide_step 12 \
#                     --data_path $data_path --unknown_nodes_num 50 \
#                     --fp_step 300 --sp_adj --no_scale
# done
...
#                     --input_features $infea --target_features $tarfea \
#                     --input_len 12 --pred_len 0 --look_back 12 --slide_step 12 \
#                     --data_path $data_path --unknown_nodes_num 81 \
#                     --fp_step 300 --sp_adj --no_scale
# done
...
#                     --input_features $infea --target_features $tarfea \
#                     --input_len 12 --pred_len 0 --look_back 12 --slide_step 12 \
#                     --data_path $data_path --unknown_nodes_num 57 \
#                     --fp_step 300 --sp_adj --no_scale
# done                
