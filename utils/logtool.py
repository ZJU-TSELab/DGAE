...
def print_train(args):
    ...
    print(
        f'├── Dims: input={args.enc_in}, latent_dim={args.latent_dim}, output={args.c_out}'
    )
...
def set_wandb(args):
    ...
    if args.wandb:
        project_name = f'DGAE-{args.dloader_name}-{args.input_len}|{args.look_back}|{args.pred_len}|{args.slide_step}|{args.task}'
        import wandb
        # wandb.require("core")
